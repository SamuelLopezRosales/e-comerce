...
class ControladorCategorias{
	...
	static public function ctrActivarCategoria($tabla,$item1,$valor1,$item2,$valor2){
	$respuesta = ModeloCategorias::mdlActivarCategoria($tabla,$item1,$valor1,$item2,$valor2);
	return $respuesta;
	}
