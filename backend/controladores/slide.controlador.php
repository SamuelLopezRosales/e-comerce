...
class ControladorSlide{
	...
	/*================================================
	METODO PARA cambiar SLIDE
	==================================================*/
	static public function ctrCambiarSlide($datos){
		$tabla = "slide";
		$ruta1 = null;
		$ruta2 = null;
		/*=============================================
		...
		$respuesta = ModeloSlide::mdlCambiarSlide($tabla, $rutaFondo,$rutaProducto, $datos);
		return $respuesta;
	}
	...
	ELIMINAR SLIDE
	===================================================================*/
	static public function ctrEliminarSlide(){
