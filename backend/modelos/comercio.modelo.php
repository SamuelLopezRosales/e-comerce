<?php
	...
	class ModeloComercio{
		...
		====================================*/
		static public function mdlActualizarLogoIcono($tabla, $id, $item,$valorNuevo){
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET $item = :$item WHERE id = :$id");
			$stmt->bindParam(":".$item,$valorNuevo,PDO::PARAM_STR);
