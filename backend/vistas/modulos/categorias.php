    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         ...
         <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarCategoria">Agregr categoría</button>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped dt-responsive tablaCategorias" width="100%">
            ...
            <!-- no traeremos toda la informacion sino que utilizaremos trosos de codigo con ajax -->
           <!-- <tbody>
              <tr>
                <td>1</td>
                <td>CURSOS</td>
                <td>Cursos</td>
                <td><button class="btn-success btn-xs">Activado</button></td>
                <td>Lorem insupt </td>
                <td>cursos aprendizaje</td>
                <td><img class="img-thumbnail" src="http://localhost:8080/e-comerce/e-comerce/backend/vistas/img/cabeceras/web.jpg" width="100px"></td>
                <th>descuento</th>
                <th>90 %</th>
                <th><img class="img-thumbnail" src="http://localhost:8080/e-comerce/e-comerce/backend/vistas/img/ofertas/cursos.jpg" width="100px"></th>
                <th>2020-12-30 22:17:18</th>
                <th>
                  <div class="btn-group">
...
?>
<!--=====================================
BLOQUEO DE LA TECLA ENTER para que no se envie el formulario al presionar enter
======================================-->
