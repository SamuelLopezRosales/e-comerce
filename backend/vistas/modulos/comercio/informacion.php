...
<div class="box box-info">
	...
	<div class="box-body formularioInformacion">
		...
		<div class="form-group">
			<label for="usr">Tasa minima Nacional:</label>
			<div class="input-group">
				<span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
		...
		<div class="form-group">
			<label for="usr">Tasa minima Internacional:</label>
			<div class="input-group">
				<span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
				...
				<div class="form-group row">
					<div class="col-xs-2">
						...
						if($comercio["modoPaypal"] == "sandbox"){
							...
							<label class="checkbox"><input class="cambioInformacion" type="radio" value="live" name="modoPaypal">
							 Live
							 </label>';
						}else{
							echo '<label class="checkbox">
							...
							<label class="checkbox"><input class="cambioInformacion" type="radio" value="live" name="modoPaypal" checked>
							 Live
							 </label>';
						}
						?>
		...
		<!-- PASARELA DE PAGO PAYU -->
			<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="text-uppercase">Configuración Payu</h4>
			</div>
			<div class="panel-body">
				<div class="form-group row">
					<div class="col-xs-2">
						...
						if($comercio["modoPayu"] == "sandbox"){
							echo '<label class="checkbox">
							<input class="cambioInformacion" type="radio" value="sandbox" name="modoPayu" checked>
							SandBox
							</label>
							<label class="checkbox"><input class="cambioInformacion" type="radio" value="live" name="modoPayu">
							 Live
							 </label>';
						}else{
							echo '<label class="checkbox">
							<input class="cambioInformacion" type="radio" value="sandbox" name="modoPayu">
							SandBox
							</label>
							<label class="checkbox"><input class="cambioInformacion" type="radio" value="live" name="modoPayu" checked>
							 Live
							 </label>';
						}
						?>
