...
class ControladorUsuarios{
		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   if($respuesta == "ok"){
					...
					$mail->setFrom('samuellopezrosales101@gmail.com', 'E-commerce-Samuel');

					$mail->addReplyTo('samuellopezrosales101@gmail.com', 'E-commerce-Samuel');
			   		...
			   		if(!envio){
						...
						swal({
			   			...
			   			echo '<script>
							...
							swal({
								  title: "¡OK!",
								  text: "¡Por favor revise su bandeja de entrada o la carpeta de SPAM de su correo electrónico '.$_POST["regEmail"].' para verificar la cuenta!",
								  type:"success",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
								},
		       ...
		       if($respuesta["email"] == $_POST["ingEmail"] && $respuesta["password"] == $encriptar){
		       		if($respuesta["verificacion"] == 1){
		       			echo '<script>
									...
									swal({
							  				...
							  				text: "¡Por favor revise la bandeja de entrada o la carperta de SPAM de su correo, para verificar la dirección de correo electronico '.$respuesta["email"].'!",
							 				type:"error",
							  				confirmButtonText: "Cerrar",
											closeOnConfirm: false
										 },
		       	...
		       	echo '<script>
									...
									swal({
							  				...
							  				text: "¡Por favor verifique que el email exista o la contraseña coincida con la registrada!",
							 				type:"error",
							  				confirmButtonText: "Cerrar",
											closeOnConfirm: false
										 },
	...
	public function ctrOlvidoPassword(){
		if(isset($_POST["passEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				// la primer respuesta es para sacar el id del usuario con ese correo electronico
				...
				echo '<script>
						...
						swal({
							  title: "¡ERROR!",
							  text: "¡Error al escribir el correo, no se permiten caracteres especiales!",
							  type:"error",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							},
	...
	static public function ctrRegistroRedesSociales($datos){
		...
		if($respuesta0){
			...
			// hasta aqui ya se registro el usuario
