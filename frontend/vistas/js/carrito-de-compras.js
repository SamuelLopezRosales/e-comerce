...
function sumaSubtotales(){
	...
	$(".sumSubTotal").html('<strong>USD $<span>'+(sumaTotal).toFixed(2)+'</span></strong>');
...
$("#btnCheckout").click(function(){
	...
	// porque se esta seleccionando cada item que esta en el carrito de compras
	...
	SUMA SUBTOTAL
	=================================================*/
	var sumaSubTotal = $(".sumSubTotal span")
	...
	for(var i=0; i<titulo.length; i++){
		...
		/*==============================================================
		EVALUAR EL PESO DEACUERDO A LA CANTIDAD DE PRODUCTOS
		=============================================================*/
		...
		$(".listaProductos table.tablaProductos tbody").append('<tr>'+
			...
			'<tr>');
		/*======================================================
		SELECCIONAR PAÍS DE ENVIO SI HAY PRODUCTOS FÍSICOS
		======================================================*/
		...
		if(tipoArray.find(checkTipo) == "fisico"){
			...
			/*=====================================================================
			EVALUAR TASAS  DE ENVIO SI HAY PRODUCTOS FISICOS
			======================================================================*/
			$("#seleccionarPais").change(function(){
				// es el pais que seleccione en el selected
				$(".alert").remove();
...
$("#cambiarDivisa").change(function(){
	...
	$.ajax({
		url: "http://free.currencyconverterapi.com/api/v3/convert?q="+divisaBase+"_"+divisa+"&compact=y&apiKey=81c76aa1235cdeaa3e95",
		type: "GET",
		cache: false,
		contentType: false,
		processData: false,
		dataType: "jsonp",
		success: function(respuesta){
			// convierto la respuesta a stringify
			var divisaString =JSON.stringify(respuesta);
			// quito los primeros 18 caracteres y agarro a partir de ahi 4
...
$(".btnPagar").click(function(){
	...
	// las variables que me esta pidiendo Paypal
