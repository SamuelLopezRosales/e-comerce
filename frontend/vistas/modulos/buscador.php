...
<?php
	...
	if(isset($rutas[3])){
		$busqueda = $rutas[3];
		$productos = ProductoControlador::ctrBuscarProductos($busqueda, $ordenar, $modo, $base, $tope);
		$listaProductos = ProductoControlador::ctrListarProductosBusqueda($busqueda);
	}
