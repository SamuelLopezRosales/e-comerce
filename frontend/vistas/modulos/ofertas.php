		...
		if($rutas[1] == "aviso"){
			echo '<div class="container-fluid">
					<div class="container">
						...
						<p class="text-center">
						Tu artículo ha sido asignado a tus compras, pero antes queremos presentarte las siguientes ofertas
						, si no deseas ver las ofertas y continuar en el articulo que acabas de adquirir haz click en el
						siguiente botón:
						<br><br>
						<a href="'.$url.'perfil">
	...
	<div class="container">
		<div class="row" id="moduloOfertas">
			<?php
				...
				/*==========================================================
				TRAEMOS LAS OFERTAS DE LA CATEGORIAS
				=========================================================¨*/
				...
				foreach ($respuesta as $key => $value) {
					...
					if($value["oferta"] == 1){
						if($value["finOferta"] > $fecha){
							...
							// sacar la distancia entre las dos fechas
				...
				/*==========================================================
				TRAEMOS LAS OFERTAS DE LAS SUBCATEGORIAS
				=========================================================¨*/
				...
				/*==========================================================
				TRAEMOS LAS OFERTAS DE LOS PRODUCTOS
				=========================================================¨*/
				$ordenar = "id";
