...
<div class="container-fluid">
  ...
  <li class="active">
  	<a data-toggle="tab" href="#compras"><i class="fa fa-list-ul"></i> MIS COMPRAS</a></li>
  <li>
  	<a data-toggle="tab" href="#deseos"><i class="fa fa-gift"></i> MI LISTA DE DESEOS</a></li>
  <li>
  	<a data-toggle="tab" href="#perfil"><i class="fa fa-user"></i> EDITAR PERFIL</a></li>
  <li>
  	<a href="<?php echo $url; ?>ofertas"><i class="fa fa-star"></i> VER OFERTAS</a></li>
</ul>
    ...
    <div class="panel-group">
    	<?php
    		...
    		if(!$compras){
    			...
    			<h2>Aun no tienes compras realizadas en está tienda</h2>
    			</div>';
    		}else{
    			foreach ($compras as $key => $value1) {
    				...
    				$productos = ProductoControlador::ctrListarProductos($ordenar,$item,$valor);
    						...
    						<figure>
    						 ...
    						 <div class="col-sm-6 col-xs-12">
    				  			...
    				  			if($value2["tipo"] == "virtual"){
    				  				...
    				  				echo '<h6>Proceso de entrega: '.$value2["entrega"].' dias hábiles</h6>';
    				  				if($value1["envio"] == 0){
    				  					echo '<div class="progress">
    				  						<div class="progress-bar progress-bar-info" role="progressbar" style="width:33.3%">
    				  							<i class="fa fa-check"></i> Despachado
    				  						</div>
    				  						<div class="progress-bar progress-bar-default" role="progressbar" style="width:33.3%">
...
==========================================================================-->
  <div id="deseos" class="tab-pane fade">
    <?php
      ...
      if(!$deseos){
        echo '<div class="col-lg-12 col-md-12 col-sm-12 text-center error404">
          <h1><small>¡Oops!</small></h1>
        ...
        echo '<li class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="col-xs-6 enlaces">
              ...
              <div class="btn-group pull-right">
                ...
                <button type="button" class="btn btn-danger btn-xs deseos quitarDeseo" idDeseo="'.$value1["id"].'" data-toggle="tooltip" title="Quitar de mi lista de deseos">
   				...
   				<div class="col-md-9 col-sm-8 col-xs-12">
   					...
   					<?php
   						if($_SESSION["modo"] != "directo"){
   							...
   							<br>
   							<label class="control-label text-muted text-uppercase">Correo:</label>
   							<div class="input-group">
   							...
   							<br>
   							<label class="control-label text-muted text-uppercase" for="editarEmail">Cambiar correo:</label>
   							<div class="input-group">
   								<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
		...
		<div class="modal-body modalTitulo">
			...
			<form method="POST" onsubmit="return validarComentario()">
    			...
    			<div class="form-group text-center">
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="0.5">0.5</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="1.0">1.0</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="1.5">1.5</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="2.0">2.0</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="2.5">2.5</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="3.0">3.0</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="3.5">3.5</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="4.0">4.0</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="4.5">4.5</label>
    				<label class="radio-inline"><input type="radio" name="puntuaje" value="5.0" checked>5.0</label>
